...
allKeys.forEach(function (element) {
  element.addEventListener("click", function () {
    /* console.log('has presionado: '+element.value); */
    ...
    switch (true) {
      ...
      case element.value == 0:
        console.log("presionaste el boton: " + element.value);
...
function IsNumber(number) {
  if (sign == "" && canTyping == true) {
    ...
    console.log("no se ingreso operador");
    if (screenNumber.value === "" || screenNumber.value === "0") {
      ...
      console.log("el valor no esta en cero, continua a concatenar");
      firstNumber += number;
      inScreenNumber = firstNumber;
      screenNumber.value = inScreenNumber;
    }
    ...
    if ((secondNumber === "" || secondNumber === "0") && canTyping == true) {
      secondNumber = number;
...
function Total() {
  switch (sign) {
    case "+":
      total = (parseFloat(firstNumber) + parseFloat(secondNumber)).toString();
      break;
